...
karakalpak_input_02 %>%
  ...
  cols_width(everything() ~ px(120)) %>%
  my_theme_gt() %>%
  gtsave('иситиш_манбалари.png', path = here("results", "tables", "karakalpak"), vwidth = 1500, vheight = 1000)
...
karakalpak_input_02 %>%
  ...
  cols_width(everything() ~ px(120)) %>%
  my_theme_gt() %>%
  gtsave('winter_readiness.png', path = here("results", "tables", "karakalpak"), vwidth = 1500, vheight = 1000)
...
karakalpak_input_02 %>%
  ...
  my_theme_gt() %>%
  gtsave('winter_readiness_2.png', path = here("results", "tables", "karakalpak"), vwidth = 1500, vheight = 1000)
